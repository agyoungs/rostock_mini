...
#define DELTA_SMOOTH_ROD_OFFSET 136.5 // mm
...
#define MANUAL_Z_HOME_POS 181.7  // For delta: Distance between nozzle and print surface after homing.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 145.982}
